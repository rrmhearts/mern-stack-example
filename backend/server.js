...
const router = express.Router(); // miniapplication. Likely not needed here, but permits modular design
...
app.use('/api', router); // attach routers in this file to endpoint /api
app.use("/api/testAPI", testAPIRouter); // attach route to endpoint.
